...
class snake(object):
    ...
    def move_computer(self, snack):
        ...
        for iterator_distance in sorted(dict_of_distance.values()):
            ...
            if dx == 1 and dy == 0 and new_direction == 'LEFT': # RIGHT
                collision_flag = 1
            elif dx == 1 and dy == 0 and new_direction == 'UP':
                for x in range(len(self.body)):
                    if self.head.pos[1]-1 == self.body[x].pos[1]:
                        collision_flag = 1
            elif dx == 1 and dy == 0 and new_direction == 'DOWN':
                for x in range(len(self.body)):
                    if self.head.pos[1]+1 == self.body[x].pos[1]:
                        collision_flag = 1
            elif dx == -1 and dy == 0 and new_direction == 'RIGHT': # LEFT
                collision_flag = 1
            elif dx == -1 and dy == 0 and new_direction == 'UP':
                for x in range(len(self.body)):
                    if self.head.pos[1]-1 == self.body[x].pos[1]:
                ...
                for x in range(len(self.body)):
                    if self.head.pos[1]+1 == self.body[x].pos[1]:
                        collision_flag = 1
            elif dx == 0 and dy == 1 and new_direction == 'UP': # DOWN
                collision_flag = 1
            elif dx == 0 and dy == 1 and new_direction == 'RIGHT':
                for x in range(len(self.body)):
                    if self.head.pos[0]+1 == self.body[x].pos[0]:
                        collision_flag = 1
            elif dx == 0 and dy == 1 and new_direction == 'LEFT':
                for x in range(len(self.body)):
                    if self.head.pos[0]-1 == self.body[x].pos[0]:
                        collision_flag = 1
            elif dx == 0 and dy == -1 and new_direction == 'DOWN': # UP
                collision_flag = 1
            elif dx == 0 and dy == -1 and new_direction == 'RIGHT':
                for x in range(len(self.body)):
                    if self.head.pos[0]+1 == self.body[x].pos[0]:
                ...
                for x in range(len(self.body)):
                    if self.head.pos[0]-1 == self.body[x].pos[0]:
                        collision_flag = 1
            elif dx == 0 and dy == -1 and self.head.pos[1]-1 < 0: # avoid upper ceil
                continue
            elif dx == 0 and dy == 1 and self.head.pos[1]+1 > 20: # avoid lower ceil
                continue
            elif dx == 1 and dy == 0 and self.head.pos[0]+1 > 20: # avoid right ceil
                continue
            elif dx == -1 and dy == 0 and self.head.pos[0]-1 < 0: # avoid left ceil
                continue
